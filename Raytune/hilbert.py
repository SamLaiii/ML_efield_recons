...
def peak_amplitude(dataloader, model, device='cpu', min_snr=1, max_snr=1e3, save_folder=''):
    ...
    for idx, channel in enumerate(channel_names):
        ...
        plt.xlabel('Peak Amplitude of Clean Data', fontsize = 18)
        plt.ylabel('Peak Amplitude of Noisy Data', fontsize = 18)
        ...
        cbar.ax.tick_params(labelsize = 18)
        plt.xlabel('Peak Amplitude of Clean Data', fontsize = 18)
        plt.ylabel('Peak Amplitude of Denoised Data', fontsize = 18)
        plt.xticks(fontsize = 18)
        plt.yticks(fontsize = 18)
        # plt.legend()
        plt.grid(True)
...
def peak_time(dataloader, model, device='cpu', min_snr=1, max_snr=1e3, save_folder=''):
    ...
    for idx, channel in enumerate(channel_names):
        ...
        plt.ylabel('Peak Time of Noisy Data (ns)', fontsize = 18 )
        # plt.title(f'Noisy vs Clean - {channel}')
        # plt.legend()
        plt.grid(True)
