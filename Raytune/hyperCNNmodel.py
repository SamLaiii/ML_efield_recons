...
class TimeDomainBranch(nn.Module):
    def __init__(self, in_channels=3, conv_channels=16, res_channels=(32, 64), dropout_rate=0.1):
...
class FrequencyDomainBranch(nn.Module):
    def __init__(self, in_channels=6, conv_channels=16, res_channels=(32, 64), dropout_rate=0.1):
...
class DualBranchAutoencoder(nn.Module):
    def __init__(self, model_config, dropout_rate=0.1):
        ...
        decoder_channels = model_config.get('decoder_channels', [32,16,8,3])

        self.time_branch = TimeDomainBranch(**time_branch_params, dropout_rate=dropout_rate)
        self.freq_branch = FrequencyDomainBranch(**freq_branch_params, dropout_rate=dropout_rate)
        self.dropout = nn.Dropout(p=dropout_rate)
